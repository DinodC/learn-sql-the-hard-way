...
-- ALTER TABLE person ADD COLUMN IF NOT EXISTS dob DATETIME;
-- PostgreSQL use DATE instead DATETIME
ALTER TABLE person ADD COLUMN IF NOT EXISTS dob DATE;

-- Add column(s) to pet
-- ALTER TABLE pet ADD COLUMN IF NOT EXISTS dob DATETIME;
-- PostgreSQL use DATE instead DATETIME
...
-- ALTER TABLE person_pet ADD COLUMN IF NOT EXISTS purchased_on DATETIME;
-- PostgreSQL use DATE instead DATETIME 
